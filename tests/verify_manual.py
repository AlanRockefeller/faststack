...
class DummyController:
    ...
    def _do_prefetch(self, *args, **kwargs): pass
    def update_histogram(self): pass
...
def run_checks():
    ...
    with patch.object(controller, 'is_valid_working_tif', return_value=True):
        ...
        if controller.current_edit_source_mode == "raw" and controller.get_active_edit_path(0) == Path("test.tif"):
